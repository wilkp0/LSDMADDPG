...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name", default="model_comm", help="Name of directory to store model/training contents")
    ...
    parser.add_argument("--n_episodes", default=600000, type=int)
